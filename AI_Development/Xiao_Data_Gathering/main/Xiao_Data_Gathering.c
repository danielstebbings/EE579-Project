/* 
    Xiao_Data_Gathering.c
    Daniel Stebbings 
    This program takes photos from the camera attached to the XIAO ESP32 Sense Board and saves to SD card
    Code has been adapted from: https://github.com/ESP32Tutorials/esp32-cam-esp-idf-take-photo-save-sd-card/tree/main
*/
